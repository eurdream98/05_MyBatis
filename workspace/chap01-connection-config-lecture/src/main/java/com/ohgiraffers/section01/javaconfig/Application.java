...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        /* DB 접속에 관한 환경 설정
        * JdbcTransactionFactory : 수동 커밋, ManagedTransactionFactory : 자동 커밋 -> 트랜잭션을 맡긴 것이다.
        * PooledDataSource : 커넥션 풀 사용, UnpooledDataSource : 커넥션풀 미사용*/
        ...
        * - false : DML 수행 후 auto commit 옵션을 false로 지정*/
        ...
        /* getMapper() : Coniguration에 등록 된 매퍼를 동일 타입에 대해 반환하는 메소드*/
