...
public class ElementService {
    ...
    public void selectResultMapCollectionTest() {
        SqlSession sqlSession = getSqlSession();
        elementTestMapper = sqlSession.getMapper(ElementTestMapper.class);
        List<CategoryAndMenuDTO> menuList = elementTestMapper.selectResultMapCollectionTest();
        menuList.forEach(System.out::println);
    ...
    public void insertCategoryAndMenuTest(MenuAndCategoryDTO menuAndCategoryDTO) {
        ...
        int result1 = elementTestMapper.insertCategoryAndMenuTest(menuAndCategoryDTO);
